-- Script do module Mestre Mandou, versão RTM 15293.089, desenvolvido por Rakan_raster#0000.
...
lang.br = {
	welcome = "<N><b>Bem-vindos ao module Mestre Mandou!</b><br>O objetivo deste module é muito simples: Siga tudo o que o jogo mandar e teste seus limites até o fim!<br><VP>Tenha sempre cuidado com os comandos trolls!<br><br><J><b>Script desenvolvido por Rakan_raster#0000</b><br>Conceito original por Jessiewind26#2546<br><br><ROSE>Versão RTM 15293.089",
	dancar = "Dance!",
	sentar = "Sente!",
...
lang.fr = {
	welcome = "<N>Bienvenue sur le module 'Maître a dit' ! Dans ce module tu dois faire tout ce que dit le maître.<br><ROSE>Module créé par <b>Rakan_raster#0000</b>. Traduit par Chatonlina#0000, Eyeground#0000 et Tortuegreen#0000. Version RTM 15293.089",
	dancar = "Danse !",
	sentar = "Assis !",
...
function eventLoop(passado,faltando)
	...
	if active == -2 then
		ui.setMapName("<N>"..text.mices.."   <G>|   <VP><b>"..text.version.." RTM 15293.089</b><")
	elseif active == -1 then
		ui.setMapName("<VP>"..text.fim.."<b>"..tempo.."</b> "..text.segundos.."   <G>|   <VP><b>"..text.version.." RTM 15293.089</b><")
	elseif active >= 0 then
		ui.setMapName(""..text.mestre.."   <G>|   <N>"..text.map.." : <V>"..tfm.get.room.currentMap.."   <G>|   <N>"..text.mice.." : <V>"..vivo.." / "..rato.."   <G>|   <N>"..text.round.." : <V>"..rodada.."   <G>|   <VP><b>"..text.version.." RTM 15293.089</b><")
	end
	if rato < 4 then
