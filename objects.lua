...
function showBar()
	for i=1,41 do
		if mapas[i] == tfm.get.room.currentMap then
			if map_names[i] == "" then
				ui.setMapName("<J><b>"..tfm.get.room.currentMap.."   </b><V>|   <N>Difficulty : <R>"..functs.level.."/8   <V>|   <N>#objects <ROSE>RTM 8460.044 LTS<")
			else
				ui.setMapName("<J><b>"..map_names[i].."</b> <BL>- "..tfm.get.room.currentMap.."   <V>|   <N>Difficulty : <R>"..functs.level.."/8   <V>|   <N>#objects <ROSE>RTM 8460.044 LTS<")
			end
		end
	end
end
