...
-- Feito por / made by Patrick_mahomes#1795, Dhanny_mheyran#6701, Akwimos#1937
-- Version 3.0
...
function updateBar()
	ui.setMapName("<D>Salto em Distância / Long Jump <V><b>v3.0</b> <CH>- by Patrick_mahomes#1795, Dhanny_mheyran#6701, Akwimos#1937<")
end
...
function eventNewPlayer(n)
	...
	if n:sub(1,1) == "*" then
		...
		showMessage("<VP>Jogo de salto em distância feito por (Long Jump Module made by) Patrick_mahomes#1795, Dhanny_mheyran#6701, Akwimos#1937. <b>Versão / Version 3.0</b>\n\n<N>Digite /mort para retornar ao ponto inicial sempre que necessário.\nType /mort to return to the start point when necessary",n)
