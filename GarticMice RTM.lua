-- Script do module GarticMice, versão RTM 0608.003, desenvolvido por Rakan_raster#0000.
...
function eventNewGame()
	...
	for n,l in pairs(tfm.get.room.playerList) do
		...
		if tfm.get.room.playerList[n].isShaman then
			...
			shaman=n
			sortearpalavra()
			tfm.exec.chatMessage(""..palavra.."","Forzaldenon#0000")
			ui.addTextArea(6014, "<font size='20'><p align='center'><font face='Bahnschrift SemiLight,Trebuchet MS,Arial'><b>Não esqueça de se mover, ou você perderá sua vez de shaman!</b>",shaman,10,25,780,30,0x241412,0x121008)
	...
	ui.setMapName("<ROSE><b>GarticMice</b> <BL>- <N>Versão RTM 0608.003 por <VP>Rakan_raster#0000")
...
function eventTextAreaCallback(ids, name, callback)
	...
	if callback == "O6i" then
		...
		tfm.exec.chatMessage(""..palavra.."","Forzaldenon#0000")
		tfm.exec.chatMessage(""..palavra.."","Viego#0345") end
