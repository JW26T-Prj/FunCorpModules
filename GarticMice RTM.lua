-- Script do module GarticMice, versão RTM 2316.011, desenvolvido por Rakan_raster#0000.
...
function eventNewGame()
	...
	for n,l in pairs(tfm.get.room.playerList) do
		...
		if tfm.get.room.playerList[n].isShaman then
			...
			showMessage(""..palavra.."","Akwimos#1937")
	...
	ui.setMapName("<ROSE><b>GarticMice</b> <BL>- <N>Versão RTM 2316.011 por <VP>Rakan_raster#0000<")
...
function eventTextAreaCallback(ids, name, callback)
	...
	if callback == "trocar" then
		...
		showMessage(""..palavra.."","Viego#0345")
		showMessage(""..palavra.."","Akwimos#1937") end
