...
-- NÃO MEXA EM NADA A PARTIR DESTA LINHA! / DON'T CHANGE ANYTHING BELOW THIS LINE! / NO CAMBIES NADA DEBAJO DE ESTA LÍNEA!
--------------------------------------------------------------------------------------------------------
...
active=-2; vivo=0; rato=0; dificuldade=1; rodadas=0; rodada=0; number=""; count=0; xpos=0; xpos2=0; pid=-1; ypos=0; data={}; grounds={}; images={}; lang={}; alives={}; fire_id={}; final=""; tempo=10; counter=0; q=""; a=""; qtime=10; creator=""; sd_vivo=0; lobby_map="@7935706"; unlocked=false;
		...
		if verifyNinjas(name) == true or verifyAdmin(name) == true then
			if active <= 0 then
				...
				if(message:sub(0,7) == "command") then
					tt={}; for i=1,138 do table.insert(tt,tostring(i)) end
			...
			if(message:sub(0,5) == "limit") then
				tt={}; for i=2,100 do table.insert(tt,tostring(i)) end
...
function eventLoop(passado,faltando)
	if unlocked == true then
		...
		if active == -2 then
			ui.setMapName("<N>"..text.mices.."   <G>|   <J><b>"..text.version.." 7.13.1</b><")
		elseif active == -1 and vivo >= 1 then
			ui.setMapName("<VP>"..text.fim.."<b>"..tempo.."</b> "..text.segundos.."   <G>|   <J><b>"..text.version.." 7.13.1</b><")
		elseif active == -1 and vivo <= 0 then
			ui.setMapName("<N>"..text.dofim.."<b>"..tempo.."</b> "..text.segundos.."   <G>|   <J><b>"..text.version.." 7.13.1</b><")
		elseif active >= 0 then
			ui.setMapName(""..text.mestre.."   <G>|   <N>"..text.map.." : <V>"..tfm.get.room.currentMap.."   <G>|   <N>"..text.mice.." : <V>"..vivo.." / "..rato.."   <G>|   <N>"..text.round.." : <V>"..rodada.."   <G>|   <J><b>"..text.version.." 7.13.1</b><")
		end
		if rato < 4 then
