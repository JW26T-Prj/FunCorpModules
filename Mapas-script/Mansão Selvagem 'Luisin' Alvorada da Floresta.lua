...
y_factor=1805; data={}; mapa="@7968780"; xml=''; changed=false; lang={}; ninjas={"Hwei#1027"}; stage=1; stage_time=0;
...
numbers1={{77,97,108,122,97,104,97,114,35,56,49,55,56},
...
function changeBackground(name)
	if data[name] then
		...
		if stage == 1 then
			...
			table.insert(data[name].images,tfm.exec.addImage("1883b1394a4.png","?-1",2100,1100,name,0.25,0.25,0,1.5))
		elseif stage == 2 then
			...
			table.insert(data[name].images,tfm.exec.addImage("1883b1394a4.png","?-1",2100,1100,name,0.25,0.25,0,0.25))
		elseif stage == 3 then
			...
			table.insert(data[name].images,tfm.exec.addImage("1883b125925.png","?-1",2150,1200,name,1,1,0,0.2))
		...
		elseif stage == 4 then
			...
			table.insert(data[name].images,tfm.exec.addImage("1883b125925.png","?-1",2150,1200,name,1,1,0,1))
...
function showWater(name)
	...
	ui.addTextArea(21, "<a href='event:board1'>                                                                  ",name,3538,1594,54,70,0,0,1.0,false)
	ui.addTextArea(22, "<a href='event:warning1'>                                                                       ",name,9048,1442,50,38,0,0,1.0,false)
	ui.addTextArea(23, "<a href='event:warning2'>                                                                       ",name,11434,1098,50,38,0,0,1.0,false)
	ui.addTextArea(24, "<a href='event:warning3'>                                                                       ",name,2486,1686,46,30,0,0,1.0,false)

	tfm.exec.addImage("19650c65000.png", "+1", -217, -30, name)
	tfm.exec.addImage("19650c68474.png", "+2", -217, -30, name)
	tfm.exec.addImage("19650c69be5.png", "+3", -217, -30, name)
	...
	for d=1,rawlen(f3) do tfm.exec.addImage("192e0195b33.png","?-1",f3[d][1],f3[d][2],name,0.5,0.5)	end
	for e=1,rawlen(f3_r) do tfm.exec.addImage("192e0195b33.png","?-1",f3_r[e][1],f3_r[e][2],name,-0.5,0.5) end
	...
	tfm.exec.addImage("18756e28db6.png", "?0", 6878, 2872, name,-1,1)
	tfm.exec.addImage("18756e2e178.png", "?0", 4391, 2915, name)
	tfm.exec.addImage("18756e333d5.png", "?0", 3782, 3014, name,-1,1)
	tfm.exec.addImage("189746e4cb8.png", "!1", 3131, 3108, name)
	tfm.exec.addImage("189746d76aa.png", "?1", 7100, 3186, name)
	tfm.exec.addImage("185c2e9722e.png", "?1", 2480, 3180, name)
	tfm.exec.addImage("19650c5349f.png", "?0", 1500, 2830, name)
	tfm.exec.addImage("192e019a18c.png", "!1", 7521, 2980, name)
	tfm.exec.addImage("192e019a18c.png", "!1", 3813, 2966, name)
	...
	tfm.exec.addPhysicObject(-5,7000,3450,ground)
	tfm.exec.addPhysicObject(-6,11000,3450,ground)
	...
	for i=0,9 do
		tfm.exec.addImage("189746fe3a4.png", "?0", -1200+(i*2000), 3330, name, 1, 1, 0, 1)
		tfm.exec.addImage("189746fe3a4.png", "?0", -1200+(i*2000), 4070, name, 1, -3, 0, 1)
	end
	tfm.exec.addImage("19650c70348.png", "!-20", -1200, y_factor+23, name,120,10)
	tfm.exec.addImage("19650c70348.png", "!-20", -1200, y_factor+4023, name,120,-10)
	tfm.exec.addImage("1897471d01c.png", "?2", 875, 2850, name,-1,1,0.2,1)
	for o=11,14 do
		tfm.exec.addImage("183b4bf34ba.png","+"..o.."",-50,-28,name)
	end
			...
			if data[name] then
				if tfm.get.room.playerList[name].y >= y_factor-8 and tfm.get.room.playerList[name].isDead == false then
					...
					if tfm.get.room.playerList[name].y >= y_factor+25 then
						data[name].d=data[name].d+math.floor(math.pow((tfm.get.room.playerList[name].y-y_factor)/40,1.88)/5)
