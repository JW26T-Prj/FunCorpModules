...
y_factor=1800; data={}; mapa="@7968780"; xml=''; changed=false; lang={}; stage=1; stage_time=0;
...
function showWater(name)
	...
	ui.addTextArea(21, "<a href='event:board1'>                                                                  ",name,3538,1594,54,70,0,0,1.1,false)
	ui.addTextArea(22, "<a href='event:warning1'>                                                                       ",name,9048,1442,50,38,0,0,1.1,false)
	ui.addTextArea(23, "<a href='event:warning2'>                                                                       ",name,11434,1098,50,38,0,0,1.1,false)
	ui.addTextArea(24, "<a href='event:warning3'>                                                                       ",name,2486,1686,46,30,0,0,1.1,false)
	...
	tfm.exec.addImage("19650c70348.png", "!-20", -1200, y_factor+23, name,120,10,0,1.01)
	tfm.exec.addImage("19650c70348.png", "!-20", -1200, y_factor+4023, name,120,-10,0,1.01)
...
function resetMap()
	if xml == '' then
		...
		ui.addTextArea(0,"",nil,-1000,-500,3000,1500,0x6a7495,0x6a7495,1.1,true)
		ui.setMapName(text.loadingmap)
		changed=false
	else
		changed=true
