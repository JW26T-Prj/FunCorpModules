...
function showWater(name)
	tfm.exec.addImage("189746c6144.png","?1",2840,1588,name)
	tfm.exec.addImage("189746f8a21.png","?1",6836,1679,name)
	tfm.exec.addImage("189746d10d2.png","!1",6638,1908,name)
	tfm.exec.addImage("189746e4cb8.png","!1",1482,1752,name)
	tfm.exec.addImage("189746e4cb8.png","!1",5262,1754,name)
	for a=1,rawlen(fish1) do
		tfm.exec.addImage("192e0192c52.png","?-1",fish1[a][1],fish1[a][2]-315,name,-0.5,0.5)
	end
	for b=1,rawlen(fish1_r) do
		tfm.exec.addImage("192e0192c52.png","?-1",fish1_r[b][1],fish1_r[b][2]-315,name,-0.5,0.5)
	end
	for a=1,rawlen(fish2) do
		tfm.exec.addImage("192e01943c1.png","?-1",fish2[a][1],fish2[a][2]-315,name)
	end
	for b=1,rawlen(fish2_r) do
		tfm.exec.addImage("192e01943c1.png","?-1",fish2_r[b][1],fish2_r[b][2]-315,name,-1,1)
	end
	for a=1,rawlen(fish3) do
		tfm.exec.addImage("192e0195b33.png","?-1",fish3[a][1],fish3[a][2]-315,name)
	end
	for b=1,rawlen(fish3_r) do
		tfm.exec.addImage("192e0195b33.png","?-1",fish3_r[b][1],fish3_r[b][2]-315,name,-1,1)
	end
	for a=1,rawlen(fish4) do
		tfm.exec.addImage("192e01972a4.png","?-1",fish4[a][1],fish4[a][2]-315,name,0.25,0.25)
	end
	for b=1,rawlen(fish4_r) do
		tfm.exec.addImage("192e01972a4.png","?-1",fish4_r[b][1],fish4_r[b][2]-315,name,-0.25,0.25)
	end
	for a=1,rawlen(fish5) do
		tfm.exec.addImage("192e0198a16.png","?-1",fish5[a][1],fish5[a][2]-315,name)
	end
	for b=1,rawlen(fish5_r) do
		tfm.exec.addImage("192e0198a16.png","?-1",fish5_r[b][1],fish5_r[b][2]-315,name,-1,1)
	end
	...
	for d=1,rawlen(ray) do
		tfm.exec.addImage("18a053a43b9.png","?-1",ray[d][1],ray[d][2]-280,name)
	end
	for e=1,rawlen(ray_r) do
		tfm.exec.addImage("18a053a43b9.png","?-1",ray_r[e][1],ray_r[e][2]-280,name,-1,1)
	end
	tfm.exec.addImage("192e017f5a8.png", "!-1", -1200, 1400, name,28,4,0,1.125)
	for i=0,1 do tfm.exec.addImage("17be536e980.png","?1",-1200+(i*5200),1500,name,1,1); end
	for _,i in next,{0,2,4} do
		tfm.exec.addImage("192e0181ef2.png", "?1", -1200+(i*2400), 1390, name) 
		tfm.exec.addImage("192e0184530.png", "?1", -600+(i*2400), 1390, name) 
		tfm.exec.addImage("192e0186807.png", "?1", i*2400, 1390, name) 
		tfm.exec.addImage("192e018872a.png", "?1", 600+(i*2400), 1390, name)
	end
	for _,i in next,{1,3,5} do
		tfm.exec.addImage("192e018872a.png", "?1", -600+(i*2400), 1390, name,-1,1)
		tfm.exec.addImage("192e0186807.png", "?1", i*2400, 1390, name,-1,1) 
		tfm.exec.addImage("192e0184530.png", "?1", 600+(i*2400), 1390, name,-1,1) 
		tfm.exec.addImage("192e0181ef2.png", "?1", 1200+(i*2400), 1390, name,-1,1)
	end
	for _,i in next,{0,2,4,6,8} do
		tfm.exec.addImage("192e01770df.png", "?1", -1200+(i*2400), 1290, name)
		tfm.exec.addImage("192e017b00d.png", "!-1", -1200+(i*2400), 1290, name,1,1)
	end
	for _,i in next,{1,3,5,7,9} do
 		tfm.exec.addImage("192e01770df.png", "?1", 1200+(i*2400), 1290, name, -1, 1)
		tfm.exec.addImage("192e017b00d.png", "!-1", 1200+(i*2400), 1290, name, -1, 1)
	end
	for i=0,9 do
		tfm.exec.addImage("192e019c182.png", "?-1", -1200+(i*1017), 1985, name, 1, 1, 0, 1)
		tfm.exec.addImage("192e019c182.png", "?-1", -1200+(i*1017), 2960, name, 1, -2, 0, 1)
	end
	for i=1,15 do
	...
	data[name].backId2 = tfm.exec.addImage("1883b1394a4.png","!1",1040,-330,name,0.5,0.5,0,0.9)
	...
	if changed == true then
		...
		if night == 0 then
			for name,player in next,tfm.get.room.playerList do
				...
				data[name].backId2 = tfm.exec.addImage("1883b1394a4.png","!1",1040,130,name,0.5,0.5,0,0.9)
				data[name].backId1 = tfm.exec.addImage("17e937f4f5a.png","?1",-800,16500,name,72,-3.6,0,0.65)
		...
		elseif night == 2 then
			for name,player in next,tfm.get.room.playerList do
				...
				data[name].backId2 = tfm.exec.addImage("1883b1394a4.png","!1",1040,130,name,0.5,0,5.0,0.4)
				data[name].backId1 = tfm.exec.addImage("17fe3741e5f.jpg", "?1", -1200, -950, name,32,2.3)
			end
			night=0
		end
