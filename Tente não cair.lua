...
function eventNewGame()
	...
	tfm.exec.setUIMapName("<J>Tente não cair <b>v1.0.9</b> - Module criado por <VP>Rivenbagassa#0000<")
 ...
 tfm.exec.chatMessage("<ROSE>Os shamans precisam alternar para o modo <b>normal</b> de shaman para jogar. Souris também não são permitidos.")
end
