...
function eventNewGame()
	iniciado=false
	ui.setMapName("                <N>Votação de Modules V2  <b>-</b>  <VP>Script gerenciado por <b>Rakan_raster#0000</b> <")
	scripts={name1="",name2="",name3="",name4="",name5="",name6="",count1=0,count2=0,count3=0,count4=0,count5=0,count6=0}
...
function eventLoop(passou, faltando)
	if faltando <= 100 and iniciado == true then
		iniciado=false
		tfm.exec.chatMessage("<br><br><br><br><br><br><br><br><br><br><VP>Estes são os resultados da votação!<br><br>")
		if script >= 2 then
...
function iniciarVotacao()
	...
	if script == 2 then
		tfm.exec.chatMessage("<br><br><br><br><br><br><br><br><ROSE><b>VOTAÇÃO INICIADA!</b><br><br><N>Digite !1 para votar no script <b>"..scripts.name1.."</b><br>ou digite !2 para votar no script <b>"..scripts.name2.."</b>.<br><br>A votação só pode ocorrer 1 vez por rato, e sua escolha pode não ser alterada.")
	elseif script == 3 then
		tfm.exec.chatMessage("<br><br><br><br><br><br><br><br><ROSE><b>VOTAÇÃO INICIADA!</b><br><br><N>Digite !1 para votar no script <b>"..scripts.name1..",</b><br>!2 para votar no script <b>"..scripts.name2.."</b><br>ou !3 para votar no script <b>"..scripts.name3.."</b>.<br><br>A votação só pode ocorrer 1 vez por rato, e sua escolha pode não ser alterada.")
	elseif script == 4 then
		tfm.exec.chatMessage("<br><br><br><br><br><br><br><br><ROSE><b>VOTAÇÃO INICIADA!</b><br><br><N>Digite !1 para votar no script <b>"..scripts.name1..",</b><br>!2 para votar no script <b>"..scripts.name2.."</b>,<br>!3 para votar no script <b>"..scripts.name3..",</b><br>ou !4 para votar no script <b>"..scripts.name4.."</b>.<br><br>A votação só pode ocorrer 1 vez por rato, e sua escolha pode não ser alterada.")
