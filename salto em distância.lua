...
function eventLoop()
	ui.setMapName("<D>Long Jump script v1.17 by <ROSE>Patrick_mahomes#1795   <V>|   <N>Higher score : <VP><b>"..recorde.."</b> <N>- <VP><b>"..recorder.."</b><")
	for name,player in pairs(tfm.get.room.playerList) do
