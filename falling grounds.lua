...
maps={'<C><P L="1600" /><Z><S><S L="10" X="800" H="10" v="10000" Y="70" T="0" P="0,0,0,0,0,0,0,0" /></S><D><DS Y="50" X="800" /></D><O /></Z></C>'}
...
function eventChatCommand(name,message)
	...
	if name == "Alisson#3938" or name == "Patrick_mahomes#1795" or name == "Aurelianlua#0000" or name == "Viego#0345" then
...
function eventNewGame()
	...
	for i=1,25 do
		...
		tfm.exec.addPhysicObject(i,math.random(100,1500),math.random(125,350),{
		...
		tfm.exec.setGameTime(70)
	end
	red = math.random(0,80); green = math.random(0,80); blue = math.random(0,80);
...
function eventLoop(p,f)
	ui.setMapName("Falling Grounds <ROSE><b>RTM 3214.008 LTS</b> <J>- made by <N><R><b>Patrick_mahomes#1795</b><")
	loop=loop+1
