...
ground_id=24; loop=-20; grounds={0,1,5,6,7,10,11,12,15,17,18};
maps={'<C><P H="400" L="1600" /><Z><S><S L="10" X="800" H="10" v="10000" Y="70" T="0" P="0,0,0,0,0,0,0,0" /></S><D><DS Y="50" X="800" /></D><O /></Z></C>'}
...
function eventLoop(p,f)
	ui.setMapName("Falling Grounds <ROSE><b>RTM 2811.005</b> <J>- made by <N><R><b>Patrick_mahomes#1795</b><")
	loop=loop+1
